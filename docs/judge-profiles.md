...
The same host-specific usage denominator applies with and without a profile, and a context budget, when set, replaces it in both cases whenever the budget is smaller or the host limit is unknown.

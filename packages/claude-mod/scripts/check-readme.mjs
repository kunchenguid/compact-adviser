// This package has no publish/pack step (it's distributed as a Claude Code plugin
...
assert.equal(
  committed,
  generated,
  "packages/claude-mod/README.md has drifted from the root README. Run `npm run sync-readmes` from the repo root and commit the result.",
);
...
console.log("packages/claude-mod/README.md matches the transformed root README.");

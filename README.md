...
| Claude Code: still unsure why | `/compact-adviser status` has a `Last turn end:` line naming what the latest settled turn came to: not checked (and which gate), judged not a checkpoint yet, or judged a checkpoint |

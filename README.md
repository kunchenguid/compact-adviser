...
| `/compact-adviser color accent` (Pi) | Hint line theme color (`accent` default; also `warning`, `info`, `success`, `muted`, `dim`, `text`). Light themes often need `accent` instead of yellow `warning` |
